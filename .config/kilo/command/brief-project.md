---
name: brief-project
description: 以项目起手与任务收敛为入口，区分新项目与已有项目，统一组织 Discovery、writing-plans 与后续 workflow 选择。
---
...
- 本 workflow 承担统一任务 intake、Discovery、writing-plans 与后续 workflow 分流职责
